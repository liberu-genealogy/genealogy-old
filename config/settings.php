...
return [
     ...
     * ReCaptcha Site Key
     */
    'reCaptchSite'   => env('RE_CAP_SITE', '6LeKYugUAAAAAH6CArdCzWCut7DesdKzNzwxwAYm'),

    /*
     * ReCaptcha Secret
     */
    'reCaptchSecret' => env('RE_CAP_SECRET', '6LeKYugUAAAAABKOS4FsLGgLjSoGWKxD8ba5xzxu'),
     ...
     * Google Maps API Key
     */
    'googleMapsAPIKey'    => env('GOOGLE_MAP_KEY', 'YOURGOOGLEMAPSkeyHERE'),
