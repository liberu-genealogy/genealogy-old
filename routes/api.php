...
use LaravelLiberu\Addresses\Http\Controllers\Create as AddressCreate;
use LaravelLiberu\Addresses\Http\Controllers\Destroy as AddressDestroy;
use LaravelLiberu\Addresses\Http\Controllers\Edit as AddressEdit;
use LaravelLiberu\Addresses\Http\Controllers\Index as AddressIndex;
use LaravelLiberu\Addresses\Http\Controllers\Localities;
use LaravelLiberu\Addresses\Http\Controllers\Localize as AddressLocalize;
use LaravelLiberu\Addresses\Http\Controllers\MakeBilling as AddressMakeBilling;
use LaravelLiberu\Addresses\Http\Controllers\MakeDefault as AddressMakeDefault;
use LaravelLiberu\Addresses\Http\Controllers\MakeShipping as AddressMakeShipping;
use LaravelLiberu\Addresses\Http\Controllers\Options as AddressOptions;
use LaravelLiberu\Addresses\Http\Controllers\Postcode;
use LaravelLiberu\Addresses\Http\Controllers\Regions;
use LaravelLiberu\Addresses\Http\Controllers\Show as AddressShow;
use LaravelLiberu\Addresses\Http\Controllers\Store as AddressStore;
use LaravelLiberu\Addresses\Http\Controllers\Update as AddressUpdate;
use LaravelLiberu\Calendar\Http\Controllers\Calendar\Create as CalendarCreate;
use LaravelLiberu\Calendar\Http\Controllers\Calendar\Destroy as CalendarDestroy;
use LaravelLiberu\Calendar\Http\Controllers\Calendar\Edit as CalendarEdit;
use LaravelLiberu\Calendar\Http\Controllers\Calendar\Index as CalendarIndex;
use LaravelLiberu\Calendar\Http\Controllers\Calendar\Options as CalendarOptions;
use LaravelLiberu\Calendar\Http\Controllers\Calendar\Store as CalendarStore;
use LaravelLiberu\Calendar\Http\Controllers\Calendar\Update as CalendarUpdate;
use LaravelLiberu\Calendar\Http\Controllers\Events\Create as EventCreate;
use LaravelLiberu\Calendar\Http\Controllers\Events\Destroy as EventDestroy;
use LaravelLiberu\Calendar\Http\Controllers\Events\Edit as EventEdit;
use LaravelLiberu\Calendar\Http\Controllers\Events\Index as EventIndex;
use LaravelLiberu\Calendar\Http\Controllers\Events\Store as EventStore;
use LaravelLiberu\Calendar\Http\Controllers\Events\Update as EventUpdate;
use LaravelLiberu\ControlPanelApi\Http\Controllers\Action as ControlPanelAction;
use LaravelLiberu\ControlPanelApi\Http\Controllers\Actions as ControlPanelActions;
use LaravelLiberu\ControlPanelApi\Http\Controllers\DownloadLog as ControlPanelDownloadLog;
use LaravelLiberu\ControlPanelApi\Http\Controllers\Statistics as ControlPanelStatistics;
 ...
 * });
 */
// use LaravelLiberu\People\Http\Controllers\TableData as PeopleTableData;
// use LaravelLiberu\People\Http\Controllers\Update as PeopleUpdate;
